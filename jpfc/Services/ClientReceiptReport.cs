...
namespace jpfc.Services
{
    public class ClientReceiptReport
    {
        ...
        private void CreatePage()
        {
            ...
            // Before you can add a row, you must define the columns.
            headerColumn = _headerTable.AddColumn(Unit.FromCentimeter(3));
            headerColumn.Format.Alignment = ParagraphAlignment.Left;
            ...
            headerColumn.Format.Alignment = ParagraphAlignment.Left;
            headerColumn = _headerTable.AddColumn(Unit.FromCentimeter(7));
            headerColumn.Format.Alignment = ParagraphAlignment.Left;
            headerColumn.Style = "Caption";
            ...
            headerRow.Cells[0].AddParagraph("Client Name:");
            headerRow.Cells[0].Format.Font.Bold = true;
            ...
            headerRow = _headerTable.AddRow();
            headerRow.Cells[0].AddParagraph("Address:");
            headerRow.Cells[0].Format.Font.Bold = true;
